...
function Invoke-ModuleScriptBody {
    ...
    process {
        ...
        Write-Verbose "Create enumeration items"
        $presentationRoot = Get-Item -Path "$sitePath/Presentation" -Language $Site.Language
        $enumerationBranchTemplate = Get-Item -Path "/sitecore/templates/Branches/Project/click-click-launch/Solterra and Co/Add Enumerations" -Language $Site.Language
        New-Item -Parent $presentationRoot -Name "Enumerations" -ItemType $enumerationBranchTemplate.ID
