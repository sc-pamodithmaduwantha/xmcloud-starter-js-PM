 ...
 * {
 *   "title": "Skate Park",
 *   "description": "A simple demo site showcasing component examples...",
 *   "lastModified": "2026-02-09T10:00:00.000Z"
 * }
 */
export async function GET(): Promise<NextResponse<SummaryResponse>> {
  const description = `Skate Park is a simple demo site showcasing component examples built with Sitecore XM Cloud and Next.js. It demonstrates modular component architecture, layout variants, and best practices for XM Cloud development with AI-ready content delivery.`;
